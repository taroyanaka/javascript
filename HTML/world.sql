CREATE TABLE `country` (
  ...
  `IndepYear` tinyint(100) DEFAULT NULL,
  `Population` tinyint(100) NOT NULL DEFAULT '0',
  ...
  `Capital` tinyint(100) DEFAULT NULL,
...
CREATE TABLE `city` (
  ...
  `Population` tinyint(100) DEFAULT NULL,
  -- `CountryCode` int NOT NULL DEFAULT '',
