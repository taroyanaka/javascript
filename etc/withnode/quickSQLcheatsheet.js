...
// copy(Array.from(document.querySelectorAll("#readme > div.Box-body.px-5.pb-5 > article > ul > li")).map(V=>{return V.textContent}).join("\n"))
const quickSQLcheatsheet = `SELECT * FROM table_name;
